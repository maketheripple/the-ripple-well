  ...
  function createMakeRippleModal() {
    ...
    modal.innerHTML = `
      <div class="make-ripple-box" role="dialog" aria-modal="true" aria-labelledby="make-ripple-title">
        <button class="make-ripple-close" type="button" aria-label="Close Make a Ripple form">×</button>
        <div class="make-ripple-kicker">MAKE A RIPPLE</div>
    ...
    form.addEventListener("submit", async event => {
      ...
      try {
        ...
        console.warn("Make a Ripple submission failed:", error);
